...
$db = mysqli_connect("localhost","root","","depo_farma");
...
function add_cart(){
    ...
    if(isset($_GET['add_cart'])){
        ...
        if(mysqli_num_rows($run_check)>0){
            ...
            echo "<script>alert('Ky produkt eshte shtuar tashme')</script>";
            echo "<script>window.open('informacione.php?pro_id=$p_id','_self')</script>";
    ...
    while($row_p_cats=mysqli_fetch_array($run_p_cats)){
        ...
        echo "
            ...
            <li>
                ...
                <a href='produkte.php?p_cat=$p_cat_id'> $p_cat_title </a>
...
function getpcatpro(){
    ...
    if(isset($_GET['p_cat'])){
        ...
        $get_products ="select * from barna where p_cat_id='$p_cat_id'";
        ...
        while($row_products=mysqli_fetch_array($run_products)){
            ...
            <div class='product'>
                ...
                <a href='informacione.php?pro_id=$pro_id'>
                    ...
                    <img class='img-responsive' src='menxher/foto/$pro_img1'>
...
function getcatpro(){
    ...
    if(isset($_GET['cat'])){
        ...
        $get_cat = "select * from barna where cat_id='$cat_id' LIMIT 0,6";
